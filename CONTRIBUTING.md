...
このプロジェクトは AGPL-3.0 ライセンスの下で公開されています。貢献いただいたコードも同じライセンスの下で公開されます。

## フォークポリシー

illoはオープンソースであり、フォークやインスタンスの運営を歓迎します。ただし、以下の点にご注意ください。
...
以下の変更を加えたフォークは、ライセンスの追加条項に違反します：

1. 利用規約同意機能の削除・無効化
   - ユーザー登録時のToS同意チェックボックスの削除
   - スクロール強制機能の削除・バイパス
   - ToS設定機能の削除
...
- 適切な利用規約を設定してください
- アーティストの権利を尊重し、スクレイピングを許可しないでください
- ソースコードを改変した場合は公開してください（AGPL-3.0の義務）
