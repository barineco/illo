  ...
  <Teleport to="body">
    ...
    >
      <div class="bg-[var(--color-surface)] rounded-lg p-6 w-full max-w-md">
        ...
        <div
          v-if="currentTier"
          class="mb-4 p-3 bg-[var(--color-background)] rounded-lg"
        >
        ...
        <div class="mb-4">
          ...
          >
            <option value="NONE">
              {{ $t('supporter.none') }} ({{ $t('admin.noSupporter') }})
            </option>
            <option value="TIER_1">
              {{ $t('supporter.tier1') }} (5GB, 20画像)
            </option>
            <option value="TIER_2">
              {{ $t('supporter.tier2') }} (10GB, 50画像)
            </option>
            <option value="TIER_3">
              {{ $t('supporter.tier3') }} (20GB, 100画像)
            </option>
          </select>
        </div>
        ...
        <!-- Tier benefits info -->
        <div
          class="mb-4 p-3 bg-[var(--color-info-bg)] border border-[var(--color-info-border)] rounded-lg"
        >
