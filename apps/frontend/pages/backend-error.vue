    ...
    <div class="max-w-2xl w-full">
      ...
      <div class="bg-[var(--color-surface)] rounded-lg p-8 shadow-xl">
        <div class="space-y-6">
          ...
          >
            <h2 class="font-medium text-[var(--color-danger-text)] mb-2">
              {{ $t('error.connectionStatus') }}
            </h2>
          ...
          <!-- Instructions -->
          <div>
            <h2 class="font-medium text-[var(--color-text)] mb-3">
              {{ $t('error.howToFix') }}
            </h2>
            <ol class="space-y-3 text-[var(--color-text-secondary)]">
              <li class="flex gap-3">
                <span
                  class="flex-shrink-0 w-6 h-6 rounded-full bg-[var(--color-primary)] text-[var(--color-primary-text)] text-sm flex items-center justify-center"
                  >1</span
                >
                <div>
                  ...
                  <code
                    class="text-sm bg-[var(--color-background)] px-2 py-1 rounded text-[var(--color-text-muted)] block mt-1"
                  >
          ...
          >
            <p class="text-xs text-[var(--color-text-muted)] text-center">
              {{ $t('error.forDevelopers') }}
              <NuxtLink
                to="/setup"
                class="text-[var(--color-primary)] hover:underline"
                >{{ $t('error.goToSetup') }}</NuxtLink
              >
            </p>
          </div>
        </div>
