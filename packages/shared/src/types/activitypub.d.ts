export type ActivityType = 'Create' | 'Update' | 'Delete' | 'Follow' | 'Accept' | 'Reject' | 'Add' | 'Remove' | 'Like' | 'Announce' | 'Undo';
...
export declare const AP_CONTEXT = "https://www.w3.org/ns/activitystreams";
export declare const AP_SECURITY_CONTEXT = "https://w3id.org/security/v1";
export declare const AP_PUBLIC = "https://www.w3.org/ns/activitystreams#Public";
